const workshops = [
    {
        ...
        descriptions: [
            ...
            "Geeignet für alle Altersgruppen, die sich für <strong>kulturelle Bildung und Dialog</strong> interessieren. Keine Vorkenntnisse erforderlich."
        ],
        duration: "3 Stunden",
        maxParticipants: "15 Teilnehmer",
        price: "€85 pro Person",
        location: "Culture Dynamics Studio, Wien",
    ...
    },
    {
        ...
        descriptions: [
            ...
            "Ideal für Sprachwissenschaftler, Kulturinteressierte und alle, die die <strong>Mehrsprachigkeit</strong> Österreichs besser verstehen möchten."
        ],
        duration: "4 Stunden",
        maxParticipants: "12 Teilnehmer",
        price: "€120 pro Person",
        location: "Culture Dynamics Studio, Wien",
        requirements: "Interesse an Sprachen und Kultur",
        includes: ["Seminarunterlagen", "Mittagspause", "Teilnahmezertifikat", "Weiterführende Literaturliste"]
    },
    {
        id: 3,
        ...
        descriptions: [
            ...
            "Für Künstler, Kulturarbeiter und Aktivisten, die <strong>nachhaltige Kulturprojekte</strong> realisieren möchten."
        ],
        duration: "6 Stunden",
        maxParticipants: "10 Teilnehmer",
        price: "€180 pro Person",
        location: "Culture Dynamics Studio, Wien",
        requirements: "Erfahrung in Kunst oder Kulturarbeit von Vorteil",
        includes: ["Projektentwicklungs-Toolkit", "1-zu-1 Beratungsgespräch", "Mittagessen", "Follow-up Session nach 4 Wochen"]
    },
    {
        id: 4,
        ...
        descriptions: [
            ...
            "Für Kulturmanager und Künstler, die ihre <strong>internationale Präsenz</strong> ausbauen möchten."
        ],
        duration: "5 Stunden",
        maxParticipants: "8 Teilnehmer",
        price: "€150 pro Person",
        location: "Culture Dynamics Studio, Wien",
        requirements: "Berufserfahrung im Kulturbereich",
        includes: ["Networking-Guide", "Internationale Kontaktliste", "Online Follow-up Workshop", "Teilnahmezertifikat"]
    },
    {
        id: 5,
        ...
        descriptions: [
            ...
            "Für erfahrene Künstler und Kulturarbeiter, die sich der <strong>Nachwuchsförderung</strong> widmen möchten."
        ],
        duration: "4 Stunden",
        maxParticipants: "12 Teilnehmer",
        price: "€110 pro Person",
        location: "Culture Dynamics Studio, Wien",
        requirements: "Erfahrung in Mentoring oder Bildungsarbeit",
        includes: ["Mentoring-Handbuch", "Praktische Übungen", "Netzwerk-Session", "Teilnahmezertifikat"]
    },
];
